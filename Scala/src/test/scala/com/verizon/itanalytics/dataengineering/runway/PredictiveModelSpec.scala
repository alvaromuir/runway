...
class PredictiveModelSpec extends FlatSpec with Builder {
  ...
  "the evaluator when evaluating models" should
    ...
    assert(arguments.size === lineVariables.length - 1)
